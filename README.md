...
1. "responseTypes": This is a matrix of length $N_Z \times N_S$ whose entries are elemetns of ${0,1,\dots,N_T - 1}$ where $N_Z$ is the number of instruments, $N_S$ is the number of response types 
